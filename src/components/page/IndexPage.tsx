...
export default function IndexPage() {
  ...
  return (
    <main className="flex flex-col items-center justify-center gap-8 pb-20">
      <h1 className="flex flex-col items-center bg-linear-to-r from-primary to-secondary bg-clip-text py-4 text-center text-transparent">
          <span className="animate-typing100 overflow-hidden whitespace-nowrap border-r-4 border-accent md:border-r-8">
            Hi! I'm David, a Full
          </span>
